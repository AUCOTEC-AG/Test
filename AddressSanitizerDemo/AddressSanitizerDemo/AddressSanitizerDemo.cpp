...
// CAddressSanitizerDemoApp

BEGIN_MESSAGE_MAP(CAddressSanitizerDemoApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CAddressSanitizerDemoApp-Erstellung

CAddressSanitizerDemoApp::CAddressSanitizerDemoApp()
{
...
// Das einzige CAddressSanitizerDemoApp-Objekt

CAddressSanitizerDemoApp theApp;


// CAddressSanitizerDemoApp-Initialisierung

BOOL CAddressSanitizerDemoApp::InitInstance()
{
